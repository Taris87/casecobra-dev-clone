        ...
        <div className="text-base sm:col-span-12 md:col-span-9">
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            ...
            <div>
              ...
              <ol className="mt-3 list-inside list-disc text-zinc-700">
                <li>Hochweriges, langlebiges Material</li>
                <li>Kratz- und Fingerabdruckresistent</li>
              </ol>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="bg-gray-50 p-6 sm:rounded-lg sm:p-8">
              <div className="flow-root text-sm">
                <div className="mt-2 flex items-center justify-between py-1">
                  <p className="text-gray-600">Standard Preis</p>
                ...
                {finish === 'textured' ? (
                  <div className="mt-2 flex items-center justify-between py-1">
                    <p className="text-gray-600">Textur Oberfläche</p>
                    <p className="font-medium text-gray-900">
            ...
            <div className="mt-8 flex justify-end pb-12">
              ...
              >
                Bestellen <ArrowRight className="ml-1.5 inline h-4 w-4" />
              </Button>
            </div>
          </div>
        </div>
